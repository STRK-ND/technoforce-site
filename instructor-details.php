    ...
    <div class="container text-center">
      ...
      <nav>
        <ol class="flex items-center justify-center space-x-3">
          ...
          <li class="text-primary">Coralina Cloud</li>
        </ol>
      </nav>
    </div>
  </div>
      ...
      <div class="grid grid-cols-12 xl:gap-0 gap-[30px]">
            ...
            <div class="px-8 pb-8">
              ...
              <ul class=" space-y-[19px]">
                <li class=" flex items-center space-x-3">
                  ...
                  <span class=" flex-1">info@designpixls.com</span>
                </li>
                <li class=" flex items-center space-x-3">
                  <div class="flex-none">
                    <span class="w-8 h-8 rounded bg-secondary text-white flex flex-col items-center justify-center text-lg">
                  ...
                  <span class=" flex-1">8939 2390 3879 29</span>
                </li>
                <li class=" flex items-center space-x-3">
                  <div class="flex-none">
                    <span class="w-8 h-8 rounded bg-secondary text-white flex flex-col items-center justify-center text-lg">
                  ...
                  <span class=" flex-1">6/2, Stavello Hall, Sydney</span>
                </li>
              </ul>
              <div class=" text-xl text-black mt-8 mb-4">Follow Me On:</div>
        ...
        <div class="lg:col-span-8 col-span-12">
          <div class="mb-10">
            ...
            <span class=" inline-block text-primary">UI/UX Designer</span>
          </div>
          <div>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vulputate pellentesque commodo. Lorem ipsum dolor sit
            amet, consectetur adipiscing elit.
            <br> <br> Donec faucibus imperdiet libero, at lacinia metus. Quisque finibus ante non arcu aliquet, nec vestibulum
                        dolor condimentum. Nulla facilisi. Vestibulum porttitor vestibulum est eu dignissim. Quisque blandit elementum
                        convallis. Ut et mi hendrerit, posuere purus ac, facilisis nibh.
          </div>
